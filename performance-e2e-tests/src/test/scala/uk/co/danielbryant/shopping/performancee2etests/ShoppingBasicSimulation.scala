package uk.co.danielbryant.shopping.performancee2etests
...
class ShoppingBasicSimulation extends Simulation {
  ...
  val primaryScenario = scenario("Shopping website and API performance test")
    .exec(http("website")
      .get("/")
      .check(
        status is 200,
